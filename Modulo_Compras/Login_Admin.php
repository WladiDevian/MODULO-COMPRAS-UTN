        ...
        <form action="Administrador/Controller/Controller_Login.php">
            ...
            <center><br><br><br><br><br><br>
                <div class="container">
                    ...
                    <input type="hidden" name="opcion" value="iniciar_sesion_admin"><br>

                    <input type="email" name="email_admin" placeholder="Ingrese el email" required="true" onkeypress="return validaCorreoElectronico(event);"maxlength="30" onchange="validaCorreoElectronico(this.form.email_admin, this.form.btng)" ><br>
                   
                    <input type="password" name="cedula_admin" placeholder="Ingrese la contraseña" required="true"  onkeypress="return SoloNumeros(event);"maxlength="10" onchange="SoloNumeros(this.form.cedula_admin, this.form.btng)"><br>
