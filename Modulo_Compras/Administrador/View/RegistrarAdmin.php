...
<form class="form-horizontal"  method="POST" action="../Controller/Controller_Admin.php">
    <input type="hidden" name="opcion" value="crear_admin">

    <div class="form-group">
        <label class="control-label col-sm-2" >Cédula</label>
        <div class="col-sm-9"><input type="text" name="cedula_admin" maxlength="10" minlength="10"required="true" class="form-control" id="ciudad" placeholder="Ingrese la cédula sin guión" onkeypress="return SoloNumeros(event);" onchange="ValidarCedula(this.form.cedula_cliente.value, this.form.btnGuardar)"  >
        </div>
    </div>
    <div class="form-group" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9"><input type="date" name="fecha_nacimiento" max="<?php echo date('1997-01-01'); ?>"  maxlength="8" required="true" class="form-control" id="apellidos" placeholder="Ingrese su fecha de nac. 19990202"  onkeypress="return SoloNumeros(event);" onchange="SoloLetras(this.form.apellido_cliente.value, this.form.btnGuardar)">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9"><input type="email" name="email" maxlength="30" required="true" class="form-control" id="apellidos"   placeholder="Ingrese el e-mail" onkeypress="return validaCorreoElectronico(event);"maxlength="30" onchange="validaCorreoElectronico(this.form.email_admin, this.form.btng)" >
        </div>
    </div>
    <div class="form-group">
