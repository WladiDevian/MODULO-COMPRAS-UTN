...
<form class="form-horizontal" method="POST"  action="../Controller/Controller_Cajero.php">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9"><input type="number" name="iva_pro" value="1" maxlength="2" minlength="1" required="true" class="form-control" id="ciudad" placeholder="Ingrese el IVA"  onkeypress="return SoloNumeros(event);" onchange="SoloNumeros(this.form.telefono_cliente.value, this.form.btnGuardar)">
        </div>
    </div>  
    <div class="form-group">
        <label class="control-label col-sm-2" >Costo</label>
        <div class="col-sm-9"><input type="number" name="costo_pro" value="1" maxlength="5" minlength="1" required="true" class="form-control" id="ciudad" placeholder="Ingrese el costo"  onkeypress="return SoloNumeros(event);" onchange="SoloNumeros(this.form.telefono_cliente.value, this.form.btnGuardar)">
        </div>
    </div> 
<!--    <div class="form-group">
        <label class="control-label col-sm-2" >PVP</label>
        <div class="col-sm-9"><input type="number" name="pvp_pro" value="1" maxlength="5" minlength="1" required="true" class="form-control" id="ciudad" placeholder="Ingrese el PVP"  onkeypress="return SoloNumeros(event);" onchange="SoloNumeros(this.form.telefono_cliente.value, this.form.btnGuardar)">
        </div>
    </div> -->
    <div class="form-group">
