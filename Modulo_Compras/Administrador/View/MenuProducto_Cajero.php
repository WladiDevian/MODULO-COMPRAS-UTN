...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Menú Producto by cajero</title>
            ...
            <BR><div  class="well well-sm">
                <nav>
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"><a href="../Controller/Controller_Cajero.php?opcion=listar_productos">Productos</a></li>
                            ...
                            <tbody>
                                ...
                                if (isset($_SESSION['listado_productos'])) {
                                    ...
                                    foreach ($listado_productos as $prods) {
                                        echo "<tr>";
                                        echo "<td><a href='../Controller/Controller_Cajero.php?opcion=editar_producto&id_pro=" . $prods->getId_pro() . "'><span class='glyphicon glyphicon-pencil'> Editar </span></a></td>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                        include './RegistrarProducto_cajero.php';
                        ?>
                    </div>
