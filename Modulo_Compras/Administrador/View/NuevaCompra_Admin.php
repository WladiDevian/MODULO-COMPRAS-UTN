            ...
            <div  class="well well-sm">
                <nav  ><center>
                        <ul class="nav nav-pills">
                            ...
                            <li class="active"><a href="MenuFactura_Admin.php">Facturas</a></li>
...
<!--                <center> <h4>Cabeza Factura</h4></center>-->
                <form  class="form-horizontal" method="POST" action="../Controller/Controller_Admin.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2"> <input type="text"  name="numero_fact"  value="<?php echo $CRUD_Admin->ultimoNumeroFactura() + 1; ?>"  onkeypress="return SoloNumeros(event);" onchange="SoloNumeros(this.form.numero_fact.value, this.form.btnGuardar)"  ><br></div>
                ...
                <form  class="form-horizontal"  action="../Controller/Controller_Admin.php">
...
//                            echo "<td>" . $i->getId_cabeza() . "</td>";
                            echo "<td><a href='../Controller/Controller_Admin.php?opcion=eliminar_detalle_factura&id_pro=" . $Factura_Det->getId_pro() . "'>Eliminar</a></td>";
...
<!--echo "<tr>";
                        ...
                        echo "<td></td>";
                        echo "<td></td>";
                        echo "<td colspan='4' align='right'> VALOR IVA TOTAL </td>";
                        echo "<td>" . $iva . " </td>";
                        echo "<td></td>";
                        echo "</tr>";
                        echo "<tr>";
                        ...
                        echo "<td></td>";
                        echo "<td></td>";
                        echo "<td colspan='5' align='right'>  VALOR TOTAL  </td>";
                        echo "<td>" . $total . "</td>";
                        echo "</tr>";-->
    ...
    <!--                        
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2"> <input  type="date" name="fecha_fact"   max="<?php //echo date('Y-m-d');               ?>" ><br></div>
                        
                        </div>
                        <div class="form-group">
                            <label  class="control-label col-sm-2" >Número Fact.</label>
                            <div class="col-sm-2"> <input  type="number" name="numero_fact"  <br></div>
