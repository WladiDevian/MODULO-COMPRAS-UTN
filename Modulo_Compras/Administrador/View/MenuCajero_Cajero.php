...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Menú Cajero by cajero</title>
            ...
            <BR><div  class="well well-sm">
                <nav>
                    <ul class="nav nav-pills">
                        ...
                        <li  class="active"><a  href="../Controller/Controller_Cajero.php?opcion=listar_cajeros">Cajeros</a></li>
                            ...
                            <tbody>
                                ...
                                if (isset($_SESSION['listado_cajeros'])) {
                                    ...
                                    foreach ($listado_cajeros as $caj) {
                                        echo "<tr>";
                                        echo "<td><a href='../Controller/Controller_Cajero.php?opcion=editar_cajero&cedula_cajero=" . $caj->getCedula_cajero() . "'><span class='glyphicon glyphicon-pencil'> Editar </span></a></td>";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                        include './RegistrarCajero_cajero.php';
                        ?>
                    </div>
