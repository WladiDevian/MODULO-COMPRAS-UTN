...
<form class="form-horizontal"  method="POST" action="../Controller/Controller_Admin.php">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9"><input type="email" name="email" maxlength="30" required="true" class="form-control" id="apellidos"   placeholder="Ingrese el e-mail" onkeypress="return validaCorreoElectronico(event);"maxlength="30" onchange="validaCorreoElectronico(this.form.email, this.form.btng)" >
        </div>
    </div>
    <div class="form-group">
